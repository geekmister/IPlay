...
function syncLegacyLanguageRuntime(code: string) {
  ...
  document.dispatchEvent(new CustomEvent('iplay:locale-change', { detail: { locale: code } }));
}

onMounted(() => {
  syncLegacyLanguageRuntime(locale.value);
});

watch(locale, (nextLocale) => {
  syncLegacyLanguageRuntime(nextLocale);
});
</script>
<template>
