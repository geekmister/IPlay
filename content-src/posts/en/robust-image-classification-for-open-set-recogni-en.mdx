---
title: Robust Image Classification for Open-Set Recognition
description: A study on open-set recognition, covering method design, evaluation metrics, and practical usability.
date: 2026-03-31
lang: en
...
seo_keywords: open-set recognition, image papers, model evaluation, deployment
readTime: 6
---
